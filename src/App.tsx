...
import { VideoPlayerComponent, useSession, useSessionUsers, useVideoState, useAudioState, VideoPlayerContainerComponent } from "./sdk";
...
export default function Videochat() {
  ...
  return (
    <div className="flex h-full w-full flex-1 flex-col">
      ...
      <div className="flex w-full flex-1" style={isInSession ? {} : { display: "none" }}>
      ...
      {!isInSession ? (
        ...
        <div className="flex w-full flex-col justify-around self-center">
          <div className="mt-4 flex w-[30rem] flex-1 justify-around self-center rounded-md bg-white p-4">
            <button type="button" onClick={() => toggleVideo()} title="toggle video">
